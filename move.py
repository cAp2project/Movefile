...
# 사용 예시
file1_path = 'your_file_path'  # 이동할 jpg 파일 경로
file2_path = 'your_file_path'  # 이동할 txt 파일 경로
destination_folder = 'destination_path'  # 목적지 폴더 경로
